...
interface CheckableInputWrapperProps<T, K extends KEYORTHIS<T>, V> extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'checked' | 'onChange' | 'value'>, ControllerProps<T, K> {
    checkedValue: V;
    uncheckedValue?: V;
}
